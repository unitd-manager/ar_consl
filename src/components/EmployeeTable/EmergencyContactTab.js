        ...
        <Col md="3">
          <FormGroup>
            ...
            <Input
              ...
              value={emergencyContactDetails?.emergency_contact_name || ''}
        ...
        <Col md="3">
          <FormGroup>
            ...
            <Input
              ...
              value={emergencyContactDetails?.emergency_contact_phone || ''}
              onChange={handleEcInputs}
              type="text"
            />
          </FormGroup>
        ...
        <Col md="3">
          <FormGroup>
            ...
            <Input
              ...
              value={emergencyContactDetails?.emergency_contact_phone2 || ''}
              onChange={handleEcInputs}
              type="text"
            />
          </FormGroup>
        ...
        <Col md="3">
          <FormGroup>
            ...
            <Input
              ...
              value={emergencyContactDetails?.emergency_contact_address || ''}
              onChange={handleEcInputs}
              type="text"
            />
          </FormGroup>
